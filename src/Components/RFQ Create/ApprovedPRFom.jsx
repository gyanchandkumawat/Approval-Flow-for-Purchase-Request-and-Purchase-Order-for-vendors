...
export default function ApprovedPRForm() {
                            ...
                            <div className="row">
                                <div className="card AddINSUBCARD">
                                    <div className="card-body p-1 ">
                                        ...
                                        <h6 className="card-title ADDINVOICECARDTITLE">Purchase Request Header Details | <span class="badge bg-success text-dark Approvedbadge me-1">Approved </span>
                                            <div className="FORMBTNSMAIN">
                                                ...
                                                &nbsp;
                                                <button type='submit' className='CREATERFQFORMBTN'>Create RFQ</button>
                                            </div>
                                        </h6>
