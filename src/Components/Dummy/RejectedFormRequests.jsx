...
export default function RejectedFormRequest() {
    ...
    const ApproverMatrixRows = [
        { id: 1, ApprovedBy: 'Rajesh Kumar', ApprovedOn: '17-05-2023 01:30:33 PM', Type: "Approver", ApproverDepartment: "IT", Approver: "Regional Controller", Level: "1", ActionTaken: "Rejected" },
    ];
    ...
    const commentsrows = [
        { id: 1, Name: 'Rajesh Kumar', Designation: "IT", Status: "Rejected", DateTime: "17-05-2023 01:30:33 PM", Remark: "Rejected from my end" },
                            ...
                            <div className="row">
                                <div className="card AddINSUBCARD">
                                    <div className="card-body p-1 ">
                                        ...
                                        <h6 className="card-title ADDINVOICECARDTITLE">Purchase Request Header Details | <span class="badge bg-danger text-light Approvedbadge me-1">Rejected </span>
                                            <div className="FORMBTNSMAIN">
                                                ...
                                                &nbsp;
                                                <button type='submit' className='G20AButtonSubmit d-none'>Submit</button>
                                                &nbsp;
                                        ...
                                        <div className="row mb-2">
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="IndentNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="Indent-00000000006" readOnly disabled />
                                            </div>
                                            <div className="col-md-2">
                                                <label htmlFor="PRNumber" className="col-form-label G20ADDFOEMLABEL">PR Number</label>
                                                <input type="text" autoComplete="off" id="PRNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="PR-00000000007-BPAAS" readOnly disabled />
                                            </div>
                                            <div className="col-md-2 d-none">
                                                <label htmlFor="RFQNumber" className="col-form-label G20ADDFOEMLABEL">RFQ Number</label>
                                                <input type="text" autoComplete="off" id="RFQNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="RFQ-00000000007" readOnly disabled />
                                            </div>
                                            <div className="col-md-2">
                                                <label htmlFor="PRNumber" className="col-form-label G20ADDFOEMLABEL">PO Number</label>
                                                <input type="text" autoComplete="off" id="PRNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="PO-00000000007" readOnly disabled />
                                            </div>
                                            <div className="col-md-2">
                                ...
                                <div className="card AddINSUBCARD">
                                    <div className="card-body p-1 mb-2">
                                        <div className="col">
                                            ...
                                            <textarea type="text" autoComplete="off" id="Site" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" required disabled></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
