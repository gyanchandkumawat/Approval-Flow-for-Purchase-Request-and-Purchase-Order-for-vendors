...
export default function QueryFormRequest() {
                                    ...
                                    <div className="card-body p-1 ">
                                        ...
                                        <div className="row mb-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="CurrencyConversion" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value=""  disabled />
                                            </div>
                                            <div className="col-md-2">
