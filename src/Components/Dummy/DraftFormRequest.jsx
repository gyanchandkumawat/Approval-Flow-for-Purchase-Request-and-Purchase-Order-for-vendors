...
import dummypdf from '../../Assets/dummy PDF/dummy.pdf'


export default function DraftFormRequest() {
                            ...
                            <div className="row">
                                <div className="card AddINSUBCARD">
                                    <div className="card-body p-1 ">
                                        ...
                                        <h6 className="card-title ADDINVOICECARDTITLE">Purchase Request Header Details | <span class="badge bg-primary text-light Approvedbadge">Draft</span>
                                        ...
                                        <div className="row mb-2">
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="IndentNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="Indent-00000000008"  disabled />
                                            </div>
                                            <div className="col-md-2 d-none">
                                                <label htmlFor="PRNumber" className="col-form-label G20ADDFOEMLABEL">PR Number</label>
                                                <input type="text" autoComplete="off" id="PRNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="PR-00000000001-BPAAS"  />
                                            </div>
                                            <div className="col-md-2 d-none">
                                                <label htmlFor="RFQNumber" className="col-form-label G20ADDFOEMLABEL">RFQ Number</label>
                                                <input type="text" autoComplete="off" id="RFQNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="RFQ-00000000001"  />
                                            </div>
                                            <div className="col-md-2 d-none">
                                                <label htmlFor="PRNumber" className="col-form-label G20ADDFOEMLABEL">PO Number</label>
                                                <input type="text" autoComplete="off" id="PRNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="PO-00000000001" />
                                            </div>
                                            <div className="col-md-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="Type" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value=""  />
                                            </div>
                                            {/* <div className="col-md-2">
                                                    ...
                                                    <div className="accordion-body ACCORDIAONBODY">
                                                        <div className="row mb-2">
                                                            <div className="col-md-3">
                                                                <label htmlFor="TypeofDocument" className="col-form-label G20ADDFOEMLABEL">Type of Document </label>
                                                            ...
                                                            <div className="col-md-3">
                                                                <label htmlFor="" className="col-form-label G20ADDFOEMLABEL">Choose Multiple files </label>
                                        ...
                                        <div className="row g-2">
                                            ...
                                            <div className="col">
                                                ...
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example"
                                                    ...
                                                    <option >Select</option>
                                                    <option value="OPEXBAG0004">OPEXBAG0004</option>
