...
export default function CreateIndent() {
    ...
    const ApproverMatrixRows = [
        { id: 1, ApprovedBy: 'Rajesh Kumar', ApprovedOn: '17-05-2023 01:30:33 PM', Type: "Approver", ApproverDepartment: "IT", Approver: "Regional Controller", Level: "1", ActionTaken: "Approved" },
    ...
    const commentsrows = [
        { id: 1, Name: 'Rajesh Kumar', Designation: "IT", Status: "Approved", DateTime: "17-05-2023 12:30:46 PM", Remark: "Approved from my end" },
    ];
                                    ...
                                    <div className="card-body p-1 ">
                                        ...
                                        <div className="row mb-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="OperatingUnit" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" />
                                            </div>
                                            <div className="col-md-2">
                                            ...
                                            {/* <div className="col-md-2 d-none">
                                                ...
                                                <input type="text" autoComplete="off" id="Preparer" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" />
                                            </div> */}
                                            <div className="col-md-2">
                                                <label htmlFor="Total" className="col-form-label G20ADDFOEMLABEL">Total</label>
                                                <input type="text" autoComplete="off" id="Total" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" />
                                            </div>
                                            <div className="col-md-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="BillTo" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" />
                                            </div>
                                            <div className="col-md-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="CurrencyConversion" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" readOnly />
                                            </div>
                                            <div className="col-md-2">
                                    ...
                                    <div className="card-body p-1">
                                        ...
                                        <div className="row mb-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="Source" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" required />
                                            </div>
                                            <div className="col-md-2">
