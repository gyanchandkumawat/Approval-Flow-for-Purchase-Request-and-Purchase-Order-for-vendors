...
export default function Acknowledge() {
    ...
    const HandelAddInvoiceForm = (event) => {
        ...
        iziToast.success({
            message: 'RFQ Acknowledged Successfully',
            position: 'topRight'
        });
        navigate("/allactivity", { replace: true });
    }
                            ...
                            <div className="row">
                                <div className="card AddINSUBCARD">
                                    <div className="card-body p-1 ">
                                        ...
                                        <h6 className="card-title ADDINVOICECARDTITLE">Vendor Header Details | <span class="badge bg-warning text-dark Approvedbadge me-1">Active</span>
                                            <div className="FORMBTNSMAIN">
                                                <button type='submit' className='PUBLISH '>Acknowledge</button>
                                            </div>
                                        </h6>
