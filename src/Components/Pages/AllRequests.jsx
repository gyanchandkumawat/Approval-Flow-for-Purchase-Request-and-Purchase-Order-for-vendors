...
export default function AllRequests() {
  ...
  const columns = [
   
    {
      ...
      renderCell: (params) => {
        // approved
        return <Link to={
          params.row.IndentNo === "Indent-00000000001" ? '/pendingformrequest'
            : (params.row.IndentNo === "Indent-00000000002" ? '/approvedformrequest'
            : params.row.IndentNo === "Indent-00000000003" ? '/rejectedformrequest' 
            : params.row.IndentNo === "Indent-00000000004" ? '/draftformrequest' 
            : params.row.IndentNo === "Indent-00000000005" ? '/queryformrequest' 
            : "")}>{params.row.IndentNo}</Link>;
      }
    },
    {
  ...
  const rows = [
    { id: "1", PurchaseRequestID: "", IndentNo: 'Indent-00000000001',PoNumber:"",RFQNumber:"", PRCreatedBy:"",PRCreatedOn:"", CreatedOn: "17-05-2023", CreatedBy: "Sanjay Kumar", Status: "Pending" },
    { id: "2", PurchaseRequestID: "PR-00000000002-BPAAS", IndentNo: 'Indent-00000000002',PoNumber:"PO-00000000002",RFQNumber:"RFQ-00000000002", PRCreatedBy:"Suresh sharma",PRCreatedOn:"17-05-2023", CreatedOn: "14-05-2023", CreatedBy: "Sanjay Kumar", Status: "Approved" },
    { id: "3", PurchaseRequestID: "PR-00000000003-BPAAS", IndentNo: 'Indent-00000000003',PoNumber:"PO-00000000003",RFQNumber:"RFQ-00000000003", PRCreatedBy:"Suresh sharma",PRCreatedOn:"18-05-2023", CreatedOn: "09-05-2023", CreatedBy: "Sanjay Kumar", Status: "Rejected" },
    { id: "4", PurchaseRequestID: "PR-00000000004-BPAAS", IndentNo: 'Indent-00000000004',PoNumber:"PO-00000000004",RFQNumber:"RFQ-00000000004", PRCreatedBy:"Suresh sharma",PRCreatedOn:"16-05-2023", CreatedOn: "08-05-2023", CreatedBy: "Sanjay Kumar", Status: "Draft" },
    { id: "5", PurchaseRequestID: "PR-00000000005-BPAAS", IndentNo: 'Indent-00000000005',PoNumber:"PO-00000000005",RFQNumber:"RFQ-00000000005", PRCreatedBy:"Suresh sharma",PRCreatedOn:"14-05-2023", CreatedOn: "04-05-2023", CreatedBy: "Sanjay Kumar", Status: "Query Raised" },
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><AddTaskIcon className='fs-5 TRCARD1CARDTITLEICON ' /> All Requests</h6>
                  </div>
