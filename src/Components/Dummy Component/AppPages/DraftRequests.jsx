...
export default function APPDraftRequests() {
  ...
  const columns = [
   ...
   
    {
      ...
      renderCell: (params) => {
        // approved
        return <Link to={
          params.row.IndentNo === "Indent-00000000008" ? '/appdraftformrequest'
  ...
  const rows = [
    // { id: "1", PurchaseRequestID: "", IndentNo: 'Indent-00000000008',PoNumber:"",RFQNumber:"", PRCreatedBy:"",PRCreatedOn:"", CreatedOn: "12-05-2023", CreatedBy: "Sanjay Kumar", Status: "Draft" },
  ];
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><SaveAsIcon className='fs-5 TRCARD1CARDTITLEICON ' /> All Draft Requests</h6>
                  </div>
