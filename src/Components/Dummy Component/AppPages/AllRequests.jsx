...
export default function APPAllRequests() {
  ...
  const columns = [
   ...
   
    {
      ...
      renderCell: (params) => {
        // approved
        return <Link to={
          params.row.IndentNo === "Indent-00000000001" ? '/apppendingformrequest'
            : (params.row.IndentNo === "Indent-00000000002" ? '/approvedformrequest' 
            : params.row.IndentNo === "Indent-00000000003" ? '/apprejectedformrequest':"")}>{params.row.IndentNo}</Link>;
      }
    },
    {
  ...
  const rows = [
    ...
    { id: "4", PurchaseRequestID: "PR-00000000004-BPAAS", IndentNo: 'Indent-00000000004',PoNumber:"PO-00000000004",RFQNumber:"RFQ-00000000004", PRCreatedBy:"Suresh sharma",PRCreatedOn:"16-05-2023", CreatedOn: "08-05-2023", CreatedBy: "Sanjay Kumar", Status: "Approved" },
    { id: "5", PurchaseRequestID: "PR-00000000005-BPAAS", IndentNo: 'Indent-00000000005',PoNumber:"PO-00000000005",RFQNumber:"RFQ-00000000005", PRCreatedBy:"Suresh sharma",PRCreatedOn:"14-05-2023", CreatedOn: "04-05-2023", CreatedBy: "Sanjay Kumar", Status: "Approved" },
