...
export default function APPPendingRequests() {
      ...
      renderCell: (params) => {
        ...
        return <Link to={
          params.row.IndentNo === "Indent-00000000001" ? '/apppendingformrequest'
            : (params.row.IndentNo === "Indent-00000000002" ? '/appapprovedformrequest' : "")}>{params.row.IndentNo}</Link>;
      }
    },
    {
  ...
  const rows = [
    ...
    // { id: "3", PurchaseRequestID: "PR-00000000003-BPAAS", IndentNo: 'Indent-00000000003',PoNumber:"PO-00000000003",RFQNumber:"RFQ-00000000003", PRCreatedBy:"Suresh sharma",PRCreatedOn:"18-05-2023", CreatedOn: "09-05-2023", CreatedBy: "Sanjay Kumar", Status: "Approved" },
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><AutorenewIcon className='fs-5 TRCARD1CARDTITLEICON ' /> All Pending Requests</h6>
                  </div>
