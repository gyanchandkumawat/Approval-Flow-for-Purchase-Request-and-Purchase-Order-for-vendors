...
export default function APPQueryRequests() {
  ...
  const columns = [
   ...
   
    {
      ...
      renderCell: (params) => {
        // approved
        return <Link to={
          params.row.IndentNo === "Indent-00000000001" ? '/queryformrequest'
  ...
  const rows = [
    // { id: "1", PurchaseRequestID: "", IndentNo: 'Indent-00000000001',PoNumber:"",RFQNumber:"", PRCreatedBy:"",PRCreatedOn:"", CreatedOn: "17-05-2023", CreatedBy: "Sanjay Kumar", Status: "Query Raised" },
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><BarChartIcon className='fs-5 TRCARD1CARDTITLEICON ' /> All Query Requests</h6>
                  </div>
