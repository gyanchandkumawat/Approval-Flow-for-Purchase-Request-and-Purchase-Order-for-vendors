...
export default function APPApprovedRequests() {
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><CheckCircleOutlineIcon className='fs-5 TRCARD1CARDTITLEICON ' /> All Approved Requests</h6>
                  </div>
