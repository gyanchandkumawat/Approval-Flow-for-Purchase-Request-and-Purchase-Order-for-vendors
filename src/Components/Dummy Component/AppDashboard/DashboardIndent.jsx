...
export default function APPDashboardIndent() {

  useEffect(() => {
    document.title = "E-COM || Dashboard"
  }, [])
  ...
  const [ALLRequestSeries, setALLRequestSeries] = useState([11]);
  // small charts
  ...
  const [PendingRequestSeries, setPendingRequestSeries] = useState([1]);
  // small charts
  ...
  const [AppRequestSeries, setAppRequestSeries] = useState([4]);
  // small charts
  ...
  const [RejRequestSeries, setRejRequestSeries] = useState([1]);
  // small charts
                      ...
                      <div className="card-body p-2">
                        <h6 className='card-title'>
                          <div>
                            ...
                            <Link to="/appallrequests"style={{textDecoration:"none"}}>
              ...
              <div className="col-md-7">
                <div className="card TREAQUESTBARCHART">
                  <div className="card-body p-2 heightfix">
                    ...
                    <Link className=" CREATEINDENT float-end d-none" to="/createindent"><EditNoteIcon className='CreateIndentIcon' />Create Indent</Link>
                  ...
                  <div className="card-body p-2">
                    <div className='d-flex DraftQuery'>
                      <div className="col">
                        ...
                        <Link to="/appallrequests" className='DRAFTQUERYMOREINFORBTN'>More Info</Link></h6>
                        <span className='TOTALDindentqury'>Total Draft Requests <b> 00</b></span><br />
                      ...
                      <div className="col">
                        <h6 className='draftheader'><EqualizerIcon className='SaveAsIcon me-1' />Query Requests <Link to="/appallrequests" className='DRAFTQUERYMOREINFORBTN'>More Info</Link></h6>
                        <span className='TOTALDindentqury'>Total Query Requests <b> 00</b></span><br />
