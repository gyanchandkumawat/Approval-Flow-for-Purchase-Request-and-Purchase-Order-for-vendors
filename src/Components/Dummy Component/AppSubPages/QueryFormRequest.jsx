...
export default function APPQueryFormRequest() {
    ...
    const [items, setItems] = useState([
        {
            id: 1,
            ItemCode: "10321",
            ItemDesc: "Laptop | 16 RAM | 1TB Hard Disk",
            Type: "Goods",
            Category: "0–9 2-in-1 PC",
            Revision: "1",
            UOM: "pieces",
            Quantity: "4",
            Price: "200000",
            NeedByDate: "20-05-2023",
    ...
    const ApproverMatrixRows = [
        { id: 1, ApprovedBy: 'Rajesh Kumar', ApprovedOn: '18-05-2023 04:25:11 PM', Type: "Approver", ApproverDepartment: "IT", Approver: "Regional Controller", Level: "1", ActionTaken: "Query Raised" },
    ...
    const commentsrows = [
        { id: 1, Name: 'Rajesh Kumar', Designation: "IT", Status: "Query Raised", DateTime: "18-05-2023 04:25:11 PM", Remark: "Quantity Wrong" },
    ];
                            ...
                            <div className="row">
                                <div className="card AddINSUBCARD">
                                    <div className="card-body p-1 ">
                                        ...
                                        <h6 className="card-title ADDINVOICECARDTITLE">Purchase Request Header Details | <span class="badge bg-info text-dark Approvedbadge">Query Raised</span>
                                            <div className="FORMBTNSMAIN">
                                                ...
                                                &nbsp;
                                                <button type='submit' className='G20AButtonSubmit'>Submit</button>
                                                &nbsp;
                                        ...
                                        <div className="row mb-2">
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="IndentNumber" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="Indent-00000000001"  disabled />
                                            </div>
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="OperatingUnit" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value=""  />
                                            </div>
                                            <div className="col-md-2">
                                                <label htmlFor="Type" className="col-form-label G20ADDFOEMLABEL">Type</label>
                                                <input type="text" autoComplete="off" id="Type" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="Goods"  />
                                            </div>
                                            {/* <div className="col-md-2">
                                                <label htmlFor="Preparer" className="col-form-label G20ADDFOEMLABEL">Preparer</label>
                                                <input type="text" autoComplete="off" id="Preparer" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value=""  />
                                            </div> */}
                                            <div className="col-md-2">
                                                <label htmlFor="Total" className="col-form-label G20ADDFOEMLABEL">Total</label>
                                                <input type="text" autoComplete="off" id="Total" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="83000"  />
                                            </div>
                                            <div className="col-md-2">
                                                ...
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example" >
                                                    ...
                                                    <option value="Business Line 1">Business Line 1</option>
                                                    <option value="Business Line 2">Business Line 2</option>
                                                    <option value="Business Line 3">Business Line 3</option>
                                                </select>
                                            </div>
                                            <div className="col-md-2">
                                                <label htmlFor="CostCenter" className="col-form-label G20ADDFOEMLABEL">Cost Center</label>
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example" id="CostCenter" >
                                                    <option selected>Select</option>
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example" id="Company" >
                                                    <option selected>Select</option>
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="CurrencyConversion" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value=""   />
                                            </div>
                                            <div className="col-md-2">
                                                <label htmlFor="CurrencyRS" className="col-form-label G20ADDFOEMLABEL">Currency in Rs/-
                                                </label>
                                                <input type="text" autoComplete="off" id="CurrencyRS" className="form-control G20ADDFOEMINPUTS1" aria-describedby=""  readOnly />
                                            </div>
                                            <div className="col-md-12">
                                                <label htmlFor="TOTALNumber" className="col-form-label G20ADDFOEMLABEL lh-0">Description
                                                </label>
                                                <textarea type="text" id="TOTALNumber" className="form-control G20ADDFOEMItextarea" aria-describedby=""  ></textarea>
                                            </div>
                                        </div>
                                        {/* header */}
                                    </div>
                            ...
                            <div className="row mt-2 mb-2">
                                <div className="card AddINSUBCARD">
                                    <h6 className="card-title ADDINVOICECARDTITLE m-1">Purchase Request Line Level Details
                                        <button type="button" className="ADLINEITEMADDBUTTON  float-end" onClick={CrudhandleModalOpen} >Add Entry</button>
                                    </h6>
                                    <hr className='mt-0' />
                                                    ...
                                                    {items.length > 0 ? (
                                                        items.map((item) => (
                                                            <tr>
                                                                ...
                                                                <td className='text-center TABLEITEMS'>
                                    ...
                                    <div className="card-body p-1">
                                        ...
                                        <div className="row mb-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="Requester" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="sanjay.kumar"  />
                                            </div>
                                            <div className="col-md-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="Source" className="form-control G20ADDFOEMINPUTS1" aria-describedby=""  />
                                            </div>
                                            <div className="col-md-2">
                                                <label htmlFor="Supplier" className="col-form-label G20ADDFOEMLABEL">Supplier</label>
                                                <input type="text" autoComplete="off" id="Supplier" className="form-control G20ADDFOEMINPUTS1" aria-describedby=""  />
                                            </div>
                                            <div className="col-md-2">
                                                <label htmlFor="Site" className="col-form-label G20ADDFOEMLABEL">Site</label>
                                                <input type="text" autoComplete="off" id="Site" className="form-control G20ADDFOEMINPUTS1" aria-describedby=""  />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div className="accordion-body ACCORDIAONBODY">
                                                        <div className="row mb-2">
                                                            <div className="col-md-3">
                                                                ...
                                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example" id='Organization' onChange={handleTypeSelect}>
                                                                    <option selected>Select</option>
                                ...
                                <div className="card AddINSUBCARD">
                                    <div className="card-body p-1 mb-2">
                                        <div className="col">
                                            ...
                                            <textarea type="text" autoComplete="off" id="Site" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" ></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <form>
                                        <div className="row g-2">
                                            <div className="col">
                                                <label htmlFor="Type" className="col-form-label G20ADDFOEMLABEL">Type</label>
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example"
                                                    id="Type" name="Type" value={Type} onChange={(event) => setType(event.target.value)} required autoComplete='off'>
                                                    <option selected>Select</option>
                                            ...
                                            <div className="col">
                                                ...
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example"
                                                    id="ItemDesc" name="ItemDesc" value={ItemDesc} onChange={(event) => setItemDesc(event.target.value)} required autoComplete='off'>
                                                    <option >Select</option>
                                            ...
                                            <div className="col">
                                                ...
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example"
                                                    id="ItemCode" name="ItemCode" value={ItemCode} onChange={(event) => setItemCode(event.target.value)} required autoComplete='off'>
                                                    <option >Select</option>
                                            ...
                                            <div className="col">
                                                ...
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example"
                                                    id="Category" name="Category" value={Category} onChange={(event) => setCategory(event.target.value)} required autoComplete='off'>
                                                    <option selected>Select</option>
                                        ...
                                        <div className="row g-2">
                                            <div className="col">
                                                ...
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example"
                                                    id="UOM" name="UOM" value={UOM} onChange={(event) => setUOM(event.target.value)} required autoComplete='off'>
                                                    <option >Select</option>
                                            ...
                                            <div className="col">
                                                ...
                                                <select className="form-select G20ADDFOEMINPUTS1SELECT" aria-label="Default select example"
                                                    id="Price" name="Price" value={Price} onChange={(event) => setPrice(event.target.value)} required autoComplete='off'>
                                                    <option >Select</option>
