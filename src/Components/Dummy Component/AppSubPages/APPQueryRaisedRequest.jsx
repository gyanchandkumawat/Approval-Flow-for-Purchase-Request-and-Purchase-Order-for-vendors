...
export default function APPQueryRaisedRequest() {
                                    ...
                                    <div className="card-body p-1 ">
                                        ...
                                        <h6 className="card-title ADDINVOICECARDTITLE">Purchase Request Header Details | <span class="badge bg-warning text-dark Approvedbadge">Pending</span>
                                            <div className="FORMBTNSMAIN">
                                                ...
                                                &nbsp;
                                                <button type='button' className='APPROVEDBTN'>Approve</button>
                                                &nbsp;
                                        ...
                                        <div className="row mb-2">
                                            ...
                                            <div className="col-md-2">
                                                ...
                                                <input type="text" autoComplete="off" id="OperatingUnit" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="" disabled />
                                            </div>
                                            <div className="col-md-2">
                                                <label htmlFor="Type" className="col-form-label G20ADDFOEMLABEL">Type</label>
                                                <input type="text" autoComplete="off" id="Type" className="form-control G20ADDFOEMINPUTS1" aria-describedby="" value="MacBook" disabled />
                                            </div>
                                            {/* <div className="col-md-2">
