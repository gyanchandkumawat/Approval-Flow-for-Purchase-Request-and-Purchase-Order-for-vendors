...
export default function AllPR() {
      ...
      renderCell: (params) => {
        ...
        return <Link to={
          params.row.IndentNo === "Indent-00000000001" ? '/prform'
            : (params.row.IndentNo === "Indent-00000000002" ? '/approvedprform' 
  ...
  const rows = [
    { id: "1", PurchaseRequestID: "PR-00000000001-BPAAS", IndentNo: 'Indent-00000000001', PRCreatedBy:"Suresh sharma",PRCreatedOn:"17-05-2023", CreatedOn: "14-05-2023", CreatedBy: "Sanjay Kumar", Status: "Pending" },
    { id: "2", PurchaseRequestID: "PR-00000000002-BPAAS", IndentNo: 'Indent-00000000002', PRCreatedBy:"Suresh sharma",PRCreatedOn:"18-05-2023", CreatedOn: "09-05-2023", CreatedBy: "Sanjay Kumar", Status: "Approved" },
    // { id: "3", PurchaseRequestID: "PR-00000000003-BPAAS", IndentNo: 'Indent-00000000003', PRCreatedBy:"Suresh sharma",PRCreatedOn:"16-05-2023", CreatedOn: "08-05-2023", CreatedBy: "Sanjay Kumar", Status: "Query Raised" },
    // { id: "4", PurchaseRequestID: "PR-00000000004-BPAAS", IndentNo: 'Indent-00000000004', PRCreatedBy:"Suresh sharma",PRCreatedOn:"14-05-2023", CreatedOn: "04-05-2023", CreatedBy: "Sanjay Kumar", Status: "Rejected" },
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><AddTaskIcon className='fs-5 TRCARD1CARDTITLEICON ' /> All PR</h6>
                  </div>
