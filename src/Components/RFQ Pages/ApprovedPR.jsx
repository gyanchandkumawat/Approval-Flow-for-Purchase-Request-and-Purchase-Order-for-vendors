...
export default function ApprovedPR() {
  ...
  const columns = [
    ...
    // },
    {
      ...
      renderCell: (params) => {
        // approved
        return <Link to={
          params.row.PRNO === "PR-00000000001-BPAAS" ? '/approvedprform'
            : (params.row.PRNO === "PR-00000000002-BPAAS" ? '/approvedprform' : "")}>{params.row.PRNO}</Link>;
      }
    }, 
    ...
    },
    {
        ...
        headerName: 'Indent Created On',
        width: 180,
        cellClassName: 'super-app-theme--cell',
      }, 
      {
        field: 'IndentCreatedBy',
        headerName: 'Indent Created By',
        width: 140,
        cellClassName: 'super-app-theme--cell',
      }, 
    {
  ...
  const rows = [
    { id: "1",IndentNo: 'Indent-00000000001',IndentCreatedOn:"23-05-2023 11:50:59 AM",IndentCreatedBy:"Sanjay Kumar", PRNO: "PR-00000000001-BPAAS",  PRCreatedBy:"Suresh sharma",PRCreatedOn:"17-05-2023 11:26:55 AM",Status: "Approved" },
    { id: "2",IndentNo: 'Indent-00000000002',IndentCreatedOn:"22-05-2023 10:03:55 AM",IndentCreatedBy:"Sanjay Kumar", PRNO: "PR-00000000002-BPAAS",  PRCreatedBy:"Suresh sharma",PRCreatedOn:"18-05-2023 10:30:55 AM",Status: "Approved" },
    { id: "3",IndentNo: 'Indent-00000000003',IndentCreatedOn:"21-05-2023 09:30:33 AM",IndentCreatedBy:"Sanjay Kumar", PRNO: "PR-00000000003-BPAAS",  PRCreatedBy:"Suresh sharma",PRCreatedOn:"16-05-2023 09:34:23 AM",Status: "Approved" },
    { id: "4",IndentNo: 'Indent-00000000004',IndentCreatedOn:"20-05-2023 10:55:15 AM",IndentCreatedBy:"Sanjay Kumar", PRNO: "PR-00000000004-BPAAS",  PRCreatedBy:"Suresh sharma",PRCreatedOn:"14-05-2023 10:23:10 AM",Status: "Approved" },
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><AddTaskIcon className='fs-5 TRCARD1CARDTITLEICON ' /> Approved PR</h6>
                  </div>
