...
export default function ClosedRFQ() {
  ...
  const columns = [
   ...
   
    {
      ...
      renderCell: (params) => {
        // approved
        return <Link to={
          params.row.RFQNumber === "RFQ-00000000002-BPAAS" ? '/closedrfqform'
  ...
  const rows = [
    { id: "1", PurchaseRequestID: "PR-00000000001-BPAAS", IndentNo: 'Indent-00000000001',PoNumber:"PO-00000000001",RFQNumber:"RFQ-00000000002-BPAAS", RFQCreatedBy:"Suresh sharma",RFQCreatedOn:"17-05-2023", PRCreatedOn: "14-05-2023", PRCreatedBy: "Sanjay Kumar", Status: "Closed" },
    { id: "2", PurchaseRequestID: "PR-00000000002-BPAAS", IndentNo: 'Indent-00000000002',PoNumber:"PO-00000000002",RFQNumber:"RFQ-00000000003-BPAAS", RFQCreatedBy:"Suresh sharma",RFQCreatedOn:"18-05-2023", PRCreatedOn: "09-05-2023", PRCreatedBy: "Sanjay Kumar", Status: "Closed" },
    { id: "3", PurchaseRequestID: "PR-00000000003-BPAAS", IndentNo: 'Indent-00000000003',PoNumber:"PO-00000000003",RFQNumber:"RFQ-00000000004-BPAAS", RFQCreatedBy:"Suresh sharma",RFQCreatedOn:"16-05-2023", PRCreatedOn: "08-05-2023", PRCreatedBy: "Sanjay Kumar", Status: "Closed" },
    { id: "4", PurchaseRequestID: "PR-00000000004-BPAAS", IndentNo: 'Indent-00000000004',PoNumber:"PO-00000000004",RFQNumber:"RFQ-00000000005-BPAAS", RFQCreatedBy:"Suresh sharma",RFQCreatedOn:"14-05-2023", PRCreatedOn: "04-05-2023", PRCreatedBy: "Sanjay Kumar", Status: "Closed" },
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><AddTaskIcon className='fs-5 TRCARD1CARDTITLEICON ' /> All Closed RFQ</h6>
                  </div>
