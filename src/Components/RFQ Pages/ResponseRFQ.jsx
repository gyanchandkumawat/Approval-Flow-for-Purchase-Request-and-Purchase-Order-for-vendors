...
export default function ResponseRFQ() {
  ...
  const columns = [
   ...
   
    {
      ...
      renderCell: (params) => {
        // approved
        return <Link to={
          params.row.RFQNumber === "RFQ-00000000002-BPAAS" ? '/responserfqform'
  ...
  const rows = [
    { id: "1", PurchaseRequestID: "PR-00000000001-BPAAS", IndentNo: 'Indent-00000000001',RFQNumber:"RFQ-00000000002-BPAAS", RFQCreatedBy:"Suresh sharma",RFQCreatedOn:"17-05-2023", CreatedOn: "14-05-2023", CreatedBy: "Sanjay Kumar", Status: "Response" },
    { id: "2", PurchaseRequestID: "PR-00000000002-BPAAS", IndentNo: 'Indent-00000000002',RFQNumber:"RFQ-00000000003-BPAAS", RFQCreatedBy:"Suresh sharma",RFQCreatedOn:"18-05-2023", CreatedOn: "09-05-2023", CreatedBy: "Sanjay Kumar", Status: "Response" },
    { id: "3", PurchaseRequestID: "PR-00000000003-BPAAS", IndentNo: 'Indent-00000000003',RFQNumber:"RFQ-00000000004-BPAAS", RFQCreatedBy:"Suresh sharma",RFQCreatedOn:"16-05-2023", CreatedOn: "08-05-2023", CreatedBy: "Sanjay Kumar", Status: "Response" },
    { id: "4", PurchaseRequestID: "PR-00000000004-BPAAS", IndentNo: 'Indent-00000000004',RFQNumber:"RFQ-00000000005-BPAAS", RFQCreatedBy:"Suresh sharma",RFQCreatedOn:"14-05-2023", CreatedOn: "04-05-2023", CreatedBy: "Sanjay Kumar", Status: "Response" },
            ...
            <div className="card-body TRMCARDBODY2">
              <div className="">
                <div className="row g-1">
                  <div className="col">
                    <h6 className="card-title TRCARD1CARDTITLE"><AddTaskIcon className='fs-5 TRCARD1CARDTITLEICON ' /> All Response RFQ</h6>
                  </div>
